<?php
    ...
    if(!empty($_GET['search']))
    {
        ...
        $data = $_GET['search'];
        $sql = "SELECT * FROM pub WHERE id LIKE '%$data%' or mes LIKE '%$data%' or leitor LIKE '%$data%' or dirigente LIKE '%$data%' or presid LIKE '%$data%' or tema LIKE '%$data%' ORDER BY id DESC";
...
<div class="table-responsive">
  ...
  <path d='M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zM8.5 4.5a.5.5 0 0 0-1 0v3h-3a.5.5 0 0 0 0 1h3v3a.5.5 0 0 0 1 0v-3h3a.5.5 0 0 0 0-1h-3v-3z'/>
    ...
    <caption class="text-center text-dark fs-5">PROGRAMAÇÃO DE FINAL DE SEMANA</caption>
    </table>
    </div>
